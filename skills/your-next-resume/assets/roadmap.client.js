/*
  ...
  All three views and every card are rendered server-side, so this file only adds:
    1. the timeline / by-resume-line / tech-tree toggle,
    2. per-browser tick state (localStorage, never written back to roadmap.md — ADR 0002/0004),
    3. the progress meter,
    4. the tech tree's click-to-select path highlighting and live locked/available state (ADR 0014),
...
(function () {
  ...
  */
  ...
  function setView(view) {
    var chosen = view === "bullets" || view === "tree" ? view : "timeline";
  ...
  var params = (location.search || "").match(/[?&]view=(timeline|bullets|tree)/);
