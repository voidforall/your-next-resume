...
**5. The Stamp is layered.** A header band beneath the name ("PROJECTION — target state \<date\>. Not a record of experience."), per-bullet marks for Projected and Reframed content, and the same statement in the PDF Title/Subject metadata. Nothing survives a determined PDF editor; the goal is that removing the Stamp is deliberate rather than accidental, so the artifact cannot be innocently mistaken for a real resume.
